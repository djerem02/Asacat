/**
 * Created by Jérémy on 31/05/2016.
 */
...
function example() {
    ...
    var tasks = [
        {"startDate":new Date("Sun Dec 09 01:36:45 EST 2012"),"endDate":new Date("Sun Dec 09 02:36:45 EST 2012"),"taskName":"tache","status":"RUNNING"},
        ...
        {"startDate":new Date("Sun Dec 09 06:29:53 EST 2012"),"endDate":new Date("Sun Dec 09 06:34:04 EST 2012"),"taskName":"tache","status":"RUNNING"},
    ...
    $('span[id^="task"]').each(function(){
    taskNames = taskNames+$('span[id^="task"]').text()+",";

    });
    //var taskNames = ["tache","filsdetest","A Job","P Job","N Job","D Job"];
    //alert(taskNames);
